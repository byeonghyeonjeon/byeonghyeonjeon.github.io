...
<h2>MVC</h2><br>
   ...
   <ul>   
    ...
    &lt; url-pattern &rt; /* &lt; url-parttern &rt; --&lt; 모든요청을 dispatch servlet에서 처리해서 문제 발생<br>
    &lt; url-pattern &rt; / &lt; url-parttern &rt; --&lt; /:default servlet ->servlet mapping 에 걸리지 않는 url처리<br><br>
    servlet-context 설정(spring에서 처리 못하는 요청처리)<br>
    &lt; mvc:default-servlet-handler &rt;<br>
